  ...
  function publicStaticVariables($this)
  {
    var maxRequests = 4;
    var window = 15;
    var requestsPerWindow = process.env.TEST === 'true' ? 3600 : 15;

    $this.MENTION_TIMEOUT = ((window*60)/requestsPerWindow)*1000;
  ...
  var $this = function(user, twitterData, lastEventId, logData) {
    ...
    // Public variables
    this.wait = $this.MENTION_TIMEOUT;
  };
  ...
  AbstractObject.extend(TwitterQueueTask, $this, {
    ...
    execute: function(logData, callback) {
      ...
      var task = this;
      TwitterInterfaceService.getMentions(this.twitterMessenger, logData, function(error, tweets) {
