  ...
  /***************************************************************************/
  /* Description: Directive for a circular progress bar                      */
  /*   - Source: https://github.com/mathewbyrne/angular-progress-arc         */
  /***************************************************************************/
    ...
    (function (angular) {
      ...
      app.directive('progressArc', ['progressArcDefaults', function (progressArcDefaults) {
        return {
          ...
          template: '<svg ng-attr-width="{{size}}" ng-attr-height="{{size}}">' +
          '<circle fill="none" ' +
          'ng-if="background" ' +
          'ng-attr-cx="{{size/2}}" ' +
          'ng-attr-cy="{{size/2}}" ' +
